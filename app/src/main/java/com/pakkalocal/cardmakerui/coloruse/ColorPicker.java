package com.pakkalocal.cardmakerui.coloruse;
...
public class ColorPicker extends View {
    ...
    private void drawPointerArrow(Canvas canvas) {
        ...
        if (vnuact != null) {
            vnuact.venue_edit.setTextColor(Color.HSVToColor(colorHSV));
            vnuact.time_edit.setTextColor(Color.HSVToColor(colorHSV));
            vnuact.date_edit.setTextColor(Color.HSVToColor(colorHSV));
        }
    }
    ...
    public void setActdata(VenueSettingsAct venueSettingsAct) {

        vnuact = venueSettingsAct;
        invalidate();
    }
}