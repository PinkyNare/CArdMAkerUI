...
public class BasicOnKeyboardActionListenerVenue implements KeyboardView.OnKeyboardActionListener {

    EditText editText;
    CustomKeyboardView displayKeyboardView;
    private VenueSettingsAct mTargetActivity;

    public BasicOnKeyboardActionListenerVenue(VenueSettingsAct targetActivity, EditText editText,
                                              CustomKeyboardView
                                                      displayKeyboardView) {
